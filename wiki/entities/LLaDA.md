...
## Overview
LLaDA(Language Large Discrete Diffusion Model)는 Meta의 discrete diffusion language model 시리즈이다. [[ReflectDrive2]]는 이 discrete diffusion LM 아키텍처를 driving domain에 적용하여 trajectory token generation에 활용한다.
...
## Connections
- [[ReflectDrive2]] — discrete trajectory token 생성에 LLaDA 아키텍처 활용
