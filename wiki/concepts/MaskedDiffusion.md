...
## Overview
Masked Diffusion은 토큰을 점진적으로 마스킹/언마스킹하여 데이터를 생성하는 discrete diffusion 패러다임이다. [[MaskGIT]], [[LLaDA]] 등 recent discrete LM에 적용되며, [[ReflectDrive2]]는 이 접근법을 trajectory token generation에 활용한다.
...
## Connections
- [[ReflectDrive2]] — trajectory token generation에 활용
