...
## Overview
Closed-Loop Planning은 시뮬레이션 환경에서 planned trajectory를 실행하고 feedback을 받아 재계획하는 iterative planning 패러다임이다. [[NAVSIM]] 벤치마크를 통해 평가되며, [[ReflectDrive2]]의 RL alignment와 밀접한 관련이 있다.
...
## Connections
- [[ReflectDrive2]] — RL-aligned closed-loop evaluation
